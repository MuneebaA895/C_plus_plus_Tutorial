...
int main()
{
    ...
    cout << *ptr << endl;  // Displays the contents of x using pointer

    // Assign 100 to the location pointed to by ptr.
    // This will actually assign 100 to x.
    *ptr = 100;

    // Use both x and ptr to display the value in x again.
    cout << "Once again, here is the value in x:\n";
    cout << x << endl;     // Displays the updated contents of x
    cout << *ptr << endl;  // Displays the updated contents of x
    return 0;
}
